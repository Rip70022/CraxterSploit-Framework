...
def main():
    ...
    while True:
        ...
        command = input(f"\n{Fore.BLUE}[{Style.RESET_ALL}{Fore.LIGHTRED_EX}CSF{Style.RESET_ALL}{Fore.BLUE}]{Style.RESET_ALL}{Fore.BLUE}〔{Style.RESET_ALL}{Fore.RED}CraxterSploit{Style.RESET_ALL}{Fore.BLUE}〕{Style.RESET_ALL}{Fore.GREEN}➜ {Style.RESET_ALL}")
